...
<head>
    ...
    .form-select {
        ...
        width: 100%;
        /* Make inputs full width of their column */
    }
...
<body>
    ...
    <div class="main-content" id="main-content">
        ...
        <section id="client-management" class="mb-5 content-section">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <!-- Button to show the add-new-client form section -->
                    <button class="btn btn-primary btn-sm" onclick="showSection('#add-new-client')">
        ...
        <section id="add-new-client" class="mb-5 content-section">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5><i class="fas fa-user-plus me-2"></i>Add New Client</h5>
                    <button class="btn btn-secondary btn-sm" onclick="showSection('#client-management')">
                ...
                <form>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="dob" placeholder="Select Date of Birth"
                                required>
                        </div>
                        <div class="col-md-6">
                            <!-- Placeholder for another field if needed, or leave empty for wider DOB on smaller screens -->
                        </div>
                    </div>
                    <hr class="my-4">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="taluka" placeholder="Enter Taluka" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info me-1" title="View Details"><i
                                            class="fas fa-eye"></i></button>
                                    <button class="btn btn-sm btn-warning me-1" title="Edit Policy"><i
                                            class="fas fa-edit"></i></button>
                                    <button class="btn btn-sm btn-danger" title="Delete Client"><i
                                            class="fas fa-edit"></i></button>
                                </td>
            ...
            <div class="dashboard-card">
                ...
                <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-3">
                    <div class="col text-center">
                        <button class="btn btn-outline-primary w-100 py-3" onclick="showSection('#add-new-client')">
    ...
    window.addEventListener('load', () => {
        ...
        // Initialize Flatpickr for the DOB field
        flatpickr("#dob", {
            dateFormat: "Y-m-d", // Internal format for submission
            maxDate: "today", // Prevent future dates
            altInput: true, // Show user-friendly date format
            altFormat: "m/d/Y", // Display format: MM/DD/YYYY
            // You can add more options here like minDate, defaultDate, etc.
        });
    });
